            ...
            if ($usertype == "empresa"):
                ...
                // IF THERE ARE NO EMPTY FIELDS THEN-
                    ...
                    try {
                        ...
                        $fetch_internships = "SELECT propostas.id_proposta, propostas.title, 
                        COUNT(candidatura.numero_aluno), MIN(candidatura.data_inicio), cursos.nome_curso
                        FROM `propostas`
                        ...
                        ORDER BY candidatura.data_inicio";
