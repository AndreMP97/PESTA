            ...
            if ($usertype == "empresa"):
                ...
                // IF THERE ARE NO EMPTY FIELDS THEN-
                    ...
                    try {
                        ...
                        $fetch_internships = "SELECT propostas.id_proposta, propostas.title, atribuicoes.data_inicio, atribuicoes.orientador, atribuicoes.numero_aluno, cursos.nome_curso
                        FROM `propostas`
