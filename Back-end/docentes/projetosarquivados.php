        ...
        if ($auth == "1"):
            ...
            if ($usertype == "docente" || $usertype == "diretor"):
                ...
                // IF THERE ARE NO EMPTY FIELDS THEN-
                    ...
                    try {
                        $fetch_projects = "SELECT propostas.id_proposta, propostas.title, propostas_dos_cursos.data_inicio, propostas_dos_cursos.data_fim, cursos.nome_curso
                        FROM `propostas`
                        ...
                        AND `arquivada` = '1' 
                        ORDER BY propostas_dos_cursos.data_fim";
                        ...
                        if($search_stmt->rowCount()):
                            while($row = $search_stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                $title[] = $row['title'];
                                $archived_date[] = date("d-m-Y", strtotime($row['data_fim']));
