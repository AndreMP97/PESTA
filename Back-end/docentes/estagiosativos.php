            ...
            if ($usertype == "docente" || $usertype == "diretor"):
                ...
                // IF THERE ARE NO EMPTY FIELDS THEN-
                    ...
                    try {
                        ...
                        $fetch_internships = "SELECT propostas.id_proposta, propostas.title, propostas_empresas.company, atribuicoes.data_inicio, atribuicoes.numero_aluno, cursos.nome_curso
                        FROM `propostas`
                        ...
                        AND `arquivada` = '0'
                        AND `aprovada` = '1'
                        ORDER BY atribuicoes.data_inicio";
