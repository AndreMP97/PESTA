            ...
            if ($usertype == "docente" || $usertype == "diretor"):
                ...
                // IF THERE ARE NO EMPTY FIELDS THEN-
                    ...
                    try {
                        ...
                        $fetch_internships = "SELECT propostas.id_proposta, propostas.title, propostas_empresas.company, atribuicoes.data_fim, atribuicoes.numero_aluno, cursos.nome_curso
                        FROM `propostas`
