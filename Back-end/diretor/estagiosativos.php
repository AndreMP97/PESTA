        ...
        if ($auth == "1"):
            ...
            if ($usertype == "diretor"):
                ...
                // IF THERE ARE NO EMPTY FIELDS THEN-
                    ...
                    try {
                        $fetch_internships = "SELECT propostas.id_proposta, propostas.title, propostas_empresas.company, propostas_dos_cursos.data_inicio, atribuicoes.orientador
                        FROM `propostas`
                        ...
                        AND propostas_empresas.company";
