            ...
            if ($usertype == "diretor"):
                ...
                // IF THERE ARE NO EMPTY FIELDS THEN-
                    ...
                    try {
                        ...
                        SET `orientador`=:supervisor 
                        WHERE `id_proposta`=:id_proposal";
                        $update_stmt = $conn->prepare($assign);
                        $update_stmt->bindValue(':supervisor', $sigla, PDO::PARAM_STR);
                        ...
                        if($update_stmt->rowCount()):
                            ...
                            $subject = "Estágio a orientar!";
                            $body = "Foi selecionado como orientador do estágio '{$title}'!";
