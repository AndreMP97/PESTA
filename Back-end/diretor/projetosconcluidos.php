        ...
        if ($auth == "1"):
            ...
            if ($usertype == "diretor"):
                ...
                // IF THERE ARE NO EMPTY FIELDS THEN-
                    ...
                    try {
                        $fetch_projects = "SELECT propostas.id_proposta, propostas.title, propostas_docentes.sigla, atribuicoes.orientador, atribuicoes.data_fim, atribuicoes.numero_aluno
                        FROM `propostas`
