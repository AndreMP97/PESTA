...
class ListRequestWithFeedback extends Component {
    _isMounted = false;
    ...
    async componentDidMount() {
        ...
        try {
            try {
                ...
                await axios.get(window.website.concat("diretor/pareceresconcluidos.php"))
                    .then(request => {
    ...
    populateProposals() {
        ...
        head.push(
            <tr key = {0}>
                ...
                <th><span style={{fontSize: 'small', fontFamily: 'verdana, geneva', color: '#FFFFFF'}}>Data do parecer </span> </th>
        ...
        for (var i = min; i < max; i++) {
            ...
            body.push(
                <tr key={i}>
                    ...
                    <td>
                        <Link to='/verpropostacurso' onClick={() => {sessionStorage.setItem("typeProposal", "feedback"); sessionStorage.setItem("id_proposta", pid);}}> 
...
export default ListRequestWithFeedback;