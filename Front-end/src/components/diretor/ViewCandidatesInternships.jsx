...
class ViewCandidatesInternships extends Component {
    constructor() {
        super();
        this.state = { 
            loading: true,
    ...
    populateCandidates() {
        ...
        if(num.length === 0) {
            entries.push(
                <tr key = {0}>
                    <td className="errorMsg">Nenhum candidato a este estágio!</td>
                    <td></td>
                    <td></td>
                    <td></td>
                </tr>
                            ...
                            <div className="Post-inner">
                                <div className="PostHeaderIcon-wrapper"> 
                                    <table style={{width: '100%', height: '20px', borderCollapse: 'collapse'}}>
                                        <tbody>
                                            <tr>
                                                <td style={{width: '80%'}} valign="middle"><span className="PostHeader"><img src={seta} alt=""/> CANDIDATOS AO ESTÁGIO</span></td>
...
export default ViewCandidatesInternships;