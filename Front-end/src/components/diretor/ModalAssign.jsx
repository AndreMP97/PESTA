...
class ModalAssign extends Component {
    ...
    async assign() {
        ...
        const assign = await axios.put(window.website.concat("diretor/atribuiraluno.php"), {
    ...
    render () {
        return (
            <div>
                ...
                >
                    <div className="modal">
                        <div className="header"> Atribuir Estágio </div>
                        <div className="content">
                            <div className="msg">
                                Atribuir o estágio "{sessionStorage.getItem("title")}" ao aluno {sessionStorage.getItem("student")}?
                            </div>
                            <br />
                        </div>
                        ...
                        <div className="content">
                            ...
                            { (this.state.success === true && this.state.error === false) ?
                                <div className="successMsg">
                                    O aluno "{sessionStorage.getItem("student")}" foi atribuído ao estágio "{sessionStorage.getItem("title")}"!
                                </div>
                                :
                                null
                            }
