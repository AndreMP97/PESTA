...
class ListProjectsWithoutCandidates extends Component {
    _isMounted = false;
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("diretor/projetosativos.php"))
                .then(request => {
    ...
    populateProposals() {
        ...
        if(body.length > 0) {
            ...
            table.push(<tbody key = {0}><tr><td className="errorMsg">Sem projetos para mostrar!</td></tr></tbody>);
        }
...
export default ListProjectsWithoutCandidates;