                                ...
                                <tbody>
                                    <tr>
                                        <td className="auto-style1" align="center" valign="middle">
                                            <Link onClick = {() => {sessionStorage.setItem("typeProposal", "request")}} to="/consultarcurso">
                                                <br />
                                                <br />
                                                <img src={folder} alt="" width={48} height={48} />
                                                <br />
                                                <br />
                                                <strong>Pedidos de Estágio <br /> do meu curso</strong>
                                                <br />
                                                <br />
                                                <br />
                                            </Link>
                                        ...
                                        <td className="auto-style1" align="center" valign="middle">
                                            <Link onClick = {() => {sessionStorage.setItem("typeProposal", "internship")}} to="/consultarcurso">
                                                <br />
                                                <br />
                                                <img src={folder} alt="" width={48} height={48} />
                                                <br />
                                                <br />
                                                <strong>Ver Estágios <br /> do meu curso</strong>
                                                <br />
                                                <br />
                                                <br />
                                            </Link>
                                        ...
                                        <td className="auto-style2"> </td>
                                        <td className="auto-style1" align="center" valign="middle">
                                            <Link onClick = {() => {sessionStorage.setItem("typeProposal", "project")}} to="/consultarcurso">
                                                <br />
                                                <br />
                                                <img src={folder} alt="" width={48} height={48} />
                                                <br />
                                                <br />
                                                <strong>Ver Projetos <br /> do meu curso</strong>
                                                <br />
                                                <br />
                                                <br />
                                            </Link>
                                    ...
                                    <tr>
                                        ...
                                        <td className="auto-style1" align="center" valign="middle">
                                            <Link to='/consultarpropostas' onClick = {() => {sessionStorage.setItem("typeProposal", "internship")}}>
                                                ...
                                                <br />
                                                <br />
                                                <strong>Os meus <br /> estágios</strong>
                                                <br />
                                                <br />
                                                <br />
                                            </Link>
...
export default withRouter(DashboardDiretor);