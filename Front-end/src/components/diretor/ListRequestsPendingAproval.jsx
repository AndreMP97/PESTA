...
class ListRequestPendingAproval extends Component {
    _isMounted = false;
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("diretor/estagiosporaprovar.php"))
                .then(request => {
        ...
        for (var i = min; i < max; i++) {
            ...
            body.push(
                <tr key={i}>
                    ...
                    <td>
                        <button onClick={() => {sessionStorage.setItem("id_proposta", pid); sessionStorage.setItem("title", ptitle); sessionStorage.setItem("currentPage", this.state.currentPage); this._approveClick();}} className="smallbutton" type="submit">Aprovar</button>
                        {
                        ...
                        <br />
                        <button onClick={() => {sessionStorage.setItem("id_proposta", pid); sessionStorage.setItem("title", ptitle); sessionStorage.setItem("currentPage", this.state.currentPage); this._rejectClick();}} className="smallbutton" type="submit">Rejeitar</button>
                        {
                    ...
                    <td>
                        <Link to='/pedirparecer' onClick={() => {sessionStorage.setItem("title", ptitle); sessionStorage.setItem("id_proposta", pid); sessionStorage.setItem("currentPage", this.state.currentPage);}}> 
                            <button className="smallbutton" type="submit" id="form-submit">Pedir Parecer</button>
                        </Link>
                    </td>
                </tr>
            );
...
export default ListRequestPendingAproval;