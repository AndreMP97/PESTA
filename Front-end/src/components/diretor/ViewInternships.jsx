...
class ViewInternships extends Component {
    constructor() {
        super();
        this.state = { 
            loading: true,
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("diretor/verestagio.php"),{
                params: {
                        ...
                        <div className="Post-body">
                            ...
                            <div className="PostHeaderIcon-wrapper"> 
                                <table style={{width: '100%', height: '20px', borderCollapse: 'collapse'}}>
                                    <tbody>
                                        <tr>
                                            <td style={{width: '80%'}} valign="middle"><span className="PostHeader"><img src={seta} alt=""/> Ver Proposta</span></td>
