...
class ModalFeedback extends Component {
    ...
    componentDidMount() {
        ...
        if(this._isMounted && sessionStorage.getItem("FeedbackModal") === "true") {
            this.handleOpenModal();
            sessionStorage.removeItem("FeedbackModal");
        }
    }
    ...
    async assign () {
        ...
        const assign = await axios.post(window.website.concat("diretor/pedirparecer.php"), {
                ...
                >
                    <div className="modal">
                        ...
                        <div className="content">
                            <div className="msg">
                                Quer pedir parecer ao docente {this.state.sigla.toUpperCase()} do estágio "{sessionStorage.getItem("title")}"?
                            </div>
                            <br />
                        </div>
                        ...
                        <div className="content">
                            ...
                            { (this.state.success === true && this.state.error === false) ?
                                <div className="successMsg">
                                    Pediu parecer ao docente {this.state.sigla.toUpperCase()} do estágio "{sessionStorage.getItem("title")}"!
                                </div>
                                :
                                null
                            }
