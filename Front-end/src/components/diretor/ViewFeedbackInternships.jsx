...
class ViewProposal extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("diretor/verfeedback.php"),{
                params: {
                            ...
                            <div className="PostHeaderIcon-wrapper"> 
                                <table style={{width: '100%', height: '20px', borderCollapse: 'collapse'}}>
                                    <tbody>
                                        <tr>
                                            ...
                                            <Link to='/consultarcurso' onClick={ () => {sessionStorage.removeItem("id_proposta");} }style={{textDecoration: 'none', color: '#FFFFFF'}}><strong><span style={{fontSize: 'small', fontFamily: 'verdana, geneva'}}>&lt; voltar</span></strong></Link></span></td>
                                        </tr>
                                    </tbody>
                                </table>
                                </div>
                                ...
                                <form id="form">
                                    <fieldset>
                                        ...
                                        <input name="comments" type="text" value={this.state.data.comments} readOnly/>
                                    </fieldset>
                                    <hr />
                                    <fieldset>
