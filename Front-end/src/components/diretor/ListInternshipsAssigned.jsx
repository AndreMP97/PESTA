...
class ListInternshipsAssigned extends Component {
    _isMounted = false;
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("diretor/estagiosatribuidos.php"))
                .then(request => {
    ...
    populateProposals() {
                ...
                body.push(
                    <tr key={i}>
                        ...
                        <td>
                            ...
                            <hr></hr>
                            <button onClick={() => {sessionStorage.setItem("id_proposta", pid); this._removeClick(); sessionStorage.setItem("title", ptitle); sessionStorage.setItem("student", student_number);}} className="smallbutton" type="submit">Remover</button>
                            {
        ...
        if(body.length > 0) {
            ...
            table.push(<tbody key = {0}><tr><td className="errorMsg">Sem estágios atríbuidos!</td></tr></tbody>);
        }
...
export default ListInternshipsAssigned;