...
class ListProjects extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("alunos/projetos.php"))
                .then(request => {
            ...
            if (pid === this.state.data.isCandidate) {
                entries.unshift(
                    <tr key={i}>
                        ...
                        <td>
                            <Link to='/verproposta' onClick={() => {sessionStorage.setItem("id_proposta", pid); sessionStorage.setItem("typeProposal", "project");}}>
                ...
                entries.push(
                    <tr key={i}>
                        ...
                        <td>
                            <Link to='/candidatar' onClick={() => {sessionStorage.setItem("id_proposta", pid); sessionStorage.setItem("typeProposal", "project");}}>
