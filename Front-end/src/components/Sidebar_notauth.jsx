            ...
            <div className="Block-body">
                <div className="BlockHeader">
                    <div className="header-tag-icon">
                        <div className="BlockHeader-text">
                            <img src={seta} alt=""/> 
                            <Link to='/login' style={{color: 'white', textDecoration: 'none', fontFamily: 'Verdana'}}> Login</Link>
                        </div>
                    </div>
                    <div className="l" />
            ...
            <div className="Block-body">
                <div className="BlockHeader">
                    <div className="header-tag-icon">
                        <div className="BlockHeader-text">
                            <img src={seta} alt=""/> 
                            <Link to='/registoempresas' style={{color: 'white', textDecoration: 'none', fontFamily: 'Verdana'}}> Registo</Link>
                        </div>
                    </div>
                    <div className="l" />
                    <div className="r"><div /></div>
...
export default Sidebar_notauth;