                    ...
                    <div className="Post-inner">
                        <div className="PostHeaderIcon-wrapper"> 
                            <table style={{width: '100%', height: '20px', borderCollapse: 'collapse'}}>
                                <tbody>
                                    <tr>
                                        <td style={{width: '80%'}} valign="middle"><span className="PostHeader"><img src={seta} alt=""/> PERFIL DA SUA EMPRESA</span></td>
                                ...
                                <tbody>
                                    <tr>
                                        <td className="auto-style1" align="center" valign="middle">
                                            <Link to='/alterardados'>
                                                <br />
                                                <br />
                                                <img src={user} alt="" width={48} height={48} />
                                                <br />
                                                <br />
                                                <strong>Alterar os meus <br/> dados</strong>
                                                <br />
                                                <br />
                                                <br />
                                            </Link>
                                        ...
                                        <td className="auto-style1" align="center" valign="middle">
                                            <Link to='/submeterproposta'>
                                                ...
                                                <br />
                                                <br />
                                                <strong>Propor<br />Estágio Curricular</strong>
                                                <br />
                                                <br />
                                            </Link>
                                        </td>
                                    ...
                                    <tr>
                                        <td className="auto-style1" align="center" valign="middle">
                                            <Link to='/consultarpropostas' onClick = {() => {sessionStorage.setItem("typeProposal", "awaiting")}}>
                                                <br />
                                                <br />
                                                <img src={folder_open} alt="" width={48} height={48} />
                                                <br />
                                                <br />
                                                <strong>As minhas <br /> propostas em <br /> análise</strong>
                                                <br />
                                                <br />
                                                <br />
                                            </Link>
                                        ...
                                        <td className="auto-style2"> </td>
                                        <td className="auto-style1" align="center" valign="middle">
                                            <Link to='/consultarpropostas' onClick = {() => {sessionStorage.setItem("typeProposal", "approved")}}>
                                                <br />
                                                <br />
                                                <img src={folder_open} alt="" width={48} height={48} />
                                                <br />
                                                <br />
                                                <strong>As minhas <br /> propostas <br /> aprovadas</strong>
                                                <br />
                                                <br />
                                            </Link>
                                        </td>
...
export default withRouter(DashboardEmpresas);