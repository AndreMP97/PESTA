...
class ListProposalsAwaiting extends Component {
    _isMounted = false;
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("empresas/estagiosporaprovar.php"))
                .then(request => {
...
export default ListProposalsAwaiting;