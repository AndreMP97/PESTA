...
class ListProposalsWithCandidates extends Component {
    _isMounted = false;
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("empresas/estagioscandidatos.php"))
                .then(request => {
...
export default ListProposalsWithCandidates;