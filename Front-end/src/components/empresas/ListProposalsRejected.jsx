...
class ListProposalsRejected extends Component {
    _isMounted = false;
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("empresas/estagiosrejeitados.php"))
                .then(request => {
...
export default ListProposalsRejected;