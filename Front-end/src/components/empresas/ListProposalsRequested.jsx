...
import Awaiting from './ListProposalsAwaiting';
import Rejected from './ListProposalsRejected'

class ListProposalsRequested extends Component {
    _isMounted = false;
                            ...
                            <div className="Post-inner">
                                <div className="PostHeaderIcon-wrapper"> 
                                    <table style={{width: '100%', height: '20px', borderCollapse: 'collapse'}}>
                                        <tbody>
                                            <tr>
                                                <td style={{width: '80%'}} valign="middle"><span className="PostHeader"><img src={seta} alt=""/> AS MINHAS PROPOSTAS DE ESTÁGIO CURRICULAR EM ANÁLISE</span></td>
                                ...
                                {/*----------------------------------------------------------------------------*/}
                                        <select className="tableselect" name="tabletype" id="tabletype" tabIndex={0} value={this.state.tabletype} onChange={onChangeValue} style={{color: '#124F87'}}>
                                            ...
                                            <option value="active">Estágios em análise</option>
...
export default ListProposalsRequested;