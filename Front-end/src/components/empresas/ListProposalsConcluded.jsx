...
class ListProposalsConcluded extends Component {
    _isMounted = false;
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("empresas/estagiosconcluidos.php"))
                .then(request => {
...
export default ListProposalsConcluded;