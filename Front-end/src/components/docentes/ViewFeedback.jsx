...
class ViewFeedback extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("docentes/verparecerconcluido.php"),{
                params: {
                        ...
                        <div className="Post-body">
                            ...
                            <div className="PostHeaderIcon-wrapper"> 
                                <table style={{width: '100%', height: '20px', borderCollapse: 'collapse'}}>
                                    <tbody>
                                        <tr>
                                            <td style={{width: '80%'}} valign="middle"><span className="PostHeader"><img src={seta} alt=""/> Ver Parecer</span></td>
                                ...
                                <form id="form">
                                    <fieldset>
                                        ...
                                        <textarea name="comments" placeholder="Comentários" value={this.state.data.comments} readOnly />
                                    </fieldset>
                                    <hr/>
                                    <fieldset>
