...
import ActiveFeedback from "./ListFeedbackActive";
import ConcludedFeedback from "./ListFeedbackConcluded";
                            ...
                            <div className="Post-inner">
                                <div className="PostHeaderIcon-wrapper"> 
                                    <table style={{width: '100%', height: '20px', borderCollapse: 'collapse'}}>
                                        <tbody>
                                            <tr>
                                                <td style={{width: '80%'}} valign="middle"><span className="PostHeader"><img src={seta} alt=""/> PEDIDOS DE PARECER</span></td>
                                ...
                                {/*----------------------------------------------------------------------------*/}
                                        <select className="tableselect" name="tabletype" id="tabletype" tabIndex={0} value={this.state.tabletype} onChange={onChangeValue} style={{color: '#124F87'}}>
                                            ...
                                            <option value="active"> Pedidos a aguardar parecer </option>
                                            <option value="concluded"> Pedidos de parecer concluídos </option>
                                        </select>
