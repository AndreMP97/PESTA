        ...
        for (var i = min; i < max; i++) {
            ...
            body.push(
                <tr key={i}>
                    ...
                    <td>
                        <button onClick={() => {sessionStorage.setItem("id_proposta", pid); this._unarchiveClick(); sessionStorage.setItem("title", ptitle); sessionStorage.setItem("currentPage", this.state.currentPage);}} className="invertedbutton" type="submit">Tornar Visível </button>  
                            {
