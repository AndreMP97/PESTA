...
class ModalRemove extends Component {
    ...
    async remove () {
        ...
        const remove = await axios.put(window.website.concat("docentes/removeraluno.php"), {
                ...
                >
                    <div className="modal">
                        ...
                        <div className="content">
                            <div className="msg">
                                Quer remover o aluno {sessionStorage.getItem("student")} do projeto "{sessionStorage.getItem("title")}"?
                            </div>
                            <br />
                        </div>
                        ...
                        <div className="content">
                            ...
                            { (this.state.success === true && this.state.error === false) ?
                                <div className="successMsg">
                                    O aluno {sessionStorage.getItem("student")} foi removido do projeto "{sessionStorage.getItem("title")}"!
                                </div>
                                :
                                null
                            }
                        ...
                        <div className="actions">
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    this.refreshPage();
                                    sessionStorage.setItem("tabletype", "candidates");
                                    sessionStorage.removeItem("title");
                                    sessionStorage.removeItem("id_proposta");
                                    sessionStorage.removeItem("student");
                                }}
