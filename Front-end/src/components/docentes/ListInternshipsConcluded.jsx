...
class ListInternshipsConcluded extends Component {
    _isMounted = false;
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("docentes/estagiosconcluidos.php"))
                .then(request => {
    ...
    populateProposals() {
        ...
        head.push(
            <tr key = {0}>
                ...
                <th><span style={{fontSize: 'small', fontFamily: 'verdana, geneva', color: '#FFFFFF'}}>Concluído a </span></th>
        ...
        if(body.length > 0) {
            ...
            table.push(<tbody key = {0}><tr><td className="errorMsg">Sem estágios por apresentar!</td></tr></tbody>);
        }
...
export default ListInternshipsConcluded;