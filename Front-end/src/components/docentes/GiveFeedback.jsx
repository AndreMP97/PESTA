...
class GiveFeedback extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            await axios.get(window.website.concat("docentes/verparecer.php"),{
                params: {
                    id:sessionStorage.getItem("id_feedback")
                }
            })
                .then(request => {
    ...
    async change() {
        ...
        axios.defaults.headers.common['Authorization'] = localStorage.getItem("sessionID");
        const request = await axios.put(window.website.concat("docentes/darparecer.php"), {
            id:sessionStorage.getItem("id_feedback"),
                        ...
                        <div className="Post-body">
                            ...
                            <div className="PostHeaderIcon-wrapper"> 
                                <table style={{width: '100%', height: '20px', borderCollapse: 'collapse'}}>
                                    <tbody>
                                        <tr>
                                            ...
                                            <Link to='/verpareceres' onClick={ () => {sessionStorage.removeItem("id_feedback"); sessionStorage.removeItem("feedback");} }style={{textDecoration: 'none', color: '#FFFFFF'}}><strong><span style={{fontSize: 'small', fontFamily: 'verdana, geneva'}}>&lt; voltar</span></strong></Link></span></td>
                                        </tr>
                                    </tbody>
                                </table>
                                </div>
                                ...
                                <fieldset>
                                    ...
                                    <hr></hr>
                                    <fieldset>
                                        <label htmlFor="comments" className="mylabel">Comentários: </label><p></p>
                                        <textarea name="comments" placeholder="Comentários" value={this.state.comments} onChange={this.onChangeValue} required />
                                    </fieldset>
                                    <fieldset>
                                        <button name="submit" type="submit" id="form-submit">Dar Parecer</button>
                                    </fieldset>
                                </form>
                                </div>
                            </div>
                        ...
                        <div className="Post-body">
                            ...
                            <div className="PostHeaderIcon-wrapper"> 
                                <table style={{width: '100%', height: '20px', borderCollapse: 'collapse'}}>
                                    <tbody>
                                        <tr>
                                            <td style={{width: '80%'}} valign="middle"><span className="PostHeader"><img src={seta} alt=""/> Dar Parecer</span></td>
                                            <td style={{width: '20%', borderLeft: '3px solid #FFFFFF'}} valign="middle" align="center"><span className="PostHeader">
                                            <Link to='/verpareceres' onClick={ () => {sessionStorage.removeItem("id_feedback"); sessionStorage.removeItem("feedback");} }style={{textDecoration: 'none', color: '#FFFFFF'}}><strong><span style={{fontSize: 'small', fontFamily: 'verdana, geneva'}}>&lt; voltar</span></strong></Link></span></td>
                                        </tr>
                                    </tbody>
                                ...
                                <h1 style={{textAlign: 'center'}}>Parecer dado com sucesso!</h1>
                                </div>
                            </div>
                        </div>
                    </div>
