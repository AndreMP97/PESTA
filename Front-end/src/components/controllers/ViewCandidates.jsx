...
import CompanyCandidates from '../empresas/ViewCandidates'
import TeacherCandidates from '../docentes/ViewCandidates'
...
class ViewCandidates extends Component {
    ...
    render() {
        ...
        if (localStorage.getItem("sessionID") && this.state.loading === false && this.state.auth) {
            ...
            if (this.state.data.usertype === "empresa") {
                return(
                    <CompanyCandidates />
                );
            }

            else if (this.state.data.usertype === "docente" || this.state.data.usertype === "diretor")  {
                return(
                    <TeacherCandidates />
                );
            }
